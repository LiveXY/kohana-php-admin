 ...
 */
Kohana::init(array(
	'base_url'   => HTTPPRO.$_SERVER['HTTP_HOST'],
));
...
Kohana::modules(array(
	...
	'kohana-mssql'	=> MODPATH.'kohana-mssql',   // mssql
	'database'		=> MODPATH.'database',   // Database access
	'captcha'		=> MODPATH.'captcha',
	'koredis'		=> MODPATH.'koredis',
...
Route::set('api', 'api(/<controller>(/<action>))')->defaults(array('directory' => 'api'));
Route::set('crontab', 'crontab(/<controller>(/<action>))')->defaults(array('directory' => 'crontab'));
